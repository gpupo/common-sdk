...
class ClientExceptionTest extends TestCaseAbstract
{
     ...
     */
    public function testSetMessage(ClientException $clientException)
    {
     ...
     * @dataProvider dataProviderClientException
     */
    public function testToLog(ClientException $clientException)
    {
     ...
     * @dataProvider dataProviderClientException
     */
    public function testAddMessagePrefix(ClientException $clientException)
    {
